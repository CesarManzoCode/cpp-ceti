...
const sheetVariants = cva(
  "fixed z-50 bg-card shadow-[var(--shadow-xl)] transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out border-border",
  {
    variants: {
      side: {
