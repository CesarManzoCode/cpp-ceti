...
export function middleware(request: NextRequest) {
  ...
  // se guarda como MEMORIA para la próxima vez que abra una ruta global
  // (`/app`, `/app/cursos`). El shell de `/app/c/[courseSlug]/...` en sí NO
  // depende de esta cookie ni de nada que ponga el middleware: sale directo
  // del parámetro de ruta en `src/app/app/c/[courseSlug]/layout.tsx`, así
  // que la sincronía entre URL y shell no pasa por aquí.
